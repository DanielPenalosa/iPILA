...
/// Wraps the StatefulNavigationShell for the department portal.
/// Mirrors AdminScaffoldWidget — sidebar + animated content area.
class DepartmentScaffoldWidget extends StatefulWidget {
  final StatefulNavigationShell navigationShell;

  const DepartmentScaffoldWidget({super.key, required this.navigationShell});

  @override
  State<DepartmentScaffoldWidget> createState() =>
      _DepartmentScaffoldWidgetState();
}

class _DepartmentScaffoldWidgetState extends State<DepartmentScaffoldWidget> {
            ...
            child: Column(
              children: [
                ...
                _TopBar(
                  ...
                  userId: user?.uid ?? '',
                  departmentName: user?.department ?? 'Department Portal',
                ),
                Expanded(
