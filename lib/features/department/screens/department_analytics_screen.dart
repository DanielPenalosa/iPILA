  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ReportModel>>(
      ...
      builder: (context, snapshot) {
        ...
        return _DeptAnalyticsBody(reports: reports, departmentName: user.department ?? 'Department');
      },
    );
  }
}

class _DeptAnalyticsBody extends StatelessWidget {
  final List<ReportModel> reports;
  final String departmentName;
  const _DeptAnalyticsBody({required this.reports, required this.departmentName});
          ...
          if (reports.isEmpty)
            ...
            Wrap(
              ...
              children: [
                ...
                _StatCard(value: '$inProgress', label: 'In Progress', sub: 'Active work', subColor: const Color(0xFF1565C0), valueColor: const Color(0xFF1565C0)),
            ...
            // ── Progress updates & resolution rate by category ───────
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Expanded(
                  child: _Card(
                    ...
                    subtitle: 'Resolved out of total per category',
                    child: _CategoryResolutionChart(reports: reports),
                  ),
                ),
                const SizedBox(width: 16),
                Expanded(
            ...
            _Card(
              ...
              subtitle: 'Done (first pass) vs Needs Revision rate',
          ...
          bottomTitles: AxisTitles(sideTitles: SideTitles(
            ...
            getTitlesWidget: (v, _) {
              ...
              return Padding(
                ...
                child: Text(label, style: const TextStyle(fontSize: 9, color: AppTheme.textMuted)),
              );
            },
          )),
          leftTitles: AxisTitles(sideTitles: SideTitles(
            showTitles: true, reservedSize: 24,
            getTitlesWidget: (v, _) => Text(v.toInt().toString(), style: const TextStyle(fontSize: 9, color: AppTheme.textMuted)),
          )),
        ...
        return Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              SizedBox(width: 24, child: Text('${e.value}', style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: AppTheme.textDark), textAlign: TextAlign.right)),
            ],
          ),
        );
      }).toList(),
                ...
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: AlwaysStoppedAnimation<Color>(
                      pct >= 0.7 ? AppTheme.successGreen : pct >= 0.4 ? Colors.orange : AppTheme.primaryRed,
                    ),
                  ),
                ),
              ),
    ...
    return SizedBox(
      ...
      child: BarChart(BarChartData(
        ...
        titlesData: FlTitlesData(
          bottomTitles: AxisTitles(sideTitles: SideTitles(
            showTitles: true,
            getTitlesWidget: (v, _) => Text(days[v.toInt()], style: const TextStyle(fontSize: 10, color: AppTheme.textMuted)),
          )),
      ...
      children: [
        Expanded(
          child: _QualityTile(
            ...
            value: '${(firstPassRate * 100).toStringAsFixed(1)}%',
            sub: '${done + resolved} of $total completed without revision',
        ...
        Expanded(
          child: _QualityTile(
            label: 'Revision Rate',
            value: '${(revisionRate * 100).toStringAsFixed(1)}%',
            sub: '$needsRevision reports returned for revision',
            color: Colors.orange,
        ...
        Expanded(
          child: _QualityTile(
            label: 'Resolved',
            value: '$resolved',
            sub: 'Admin-verified completions',
