            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (needsAction > 0)
                    _AlertChip(label: '$needsAction need action', isRed: false),
                ],
              ),
              ...
              if (revisionRequired > 0) ...[
                _Banner(
                  ...
                  text:
                      '$revisionRequired report${revisionRequired > 1 ? 's' : ''} returned for revision by admin.',
                ),
...
class _AlertChip extends StatelessWidget {
  final String label;
  final bool isRed;
  const _AlertChip({required this.label, required this.isRed});

  @override
  Widget build(BuildContext context) {
    final color = isRed ? const Color(0xFFDC2626) : const Color(0xFFF59E0B);
    return Container(
