                ...
                Container(
                  ...
                  child: ListView.separated(
                    ...
                    separatorBuilder: (_, __) => const Divider(
                        height: 1, color: Color(0xFFF9FAFB), indent: 56),
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Icon(Icons.notifications_none_outlined, size: 48, color: Colors.grey[200]),
...
class _NotifTile extends StatelessWidget {
  ...
  IconData get _icon {
    switch (n.type) {
      ...
      case 'progress': return Icons.sync_rounded;
  ...
  Color get _color {
    switch (n.type) {
      ...
      case 'progress': return const Color(0xFF3B82F6);
      case 'success': return const Color(0xFF10B981);
      case 'warning': return const Color(0xFFDC2626);
    ...
    return MouseRegion(
      ...
      child: InkWell(
        onTap: () {
          ...
          if (hasReport) context.go('/barangay/reports/${n.reportId}');
        },
        borderRadius: BorderRadius.circular(12),
        child: Container(
          padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 14),
          decoration: BoxDecoration(
            color: n.isRead ? Colors.transparent : const Color(0xFFF6FFF9),
            borderRadius: BorderRadius.circular(12),
          ),
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(
                width: 36, height: 36,
                decoration: BoxDecoration(
                    color: _color.withValues(alpha: 0.08), shape: BoxShape.circle),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(DateFormat('MMM d, yyyy · h:mm a').format(n.createdAt),
